    ...
    <head>
      ...
      <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @media (max-width: 768px) { body { flex-direction: column; } #sidebar { width: 100%; border-bottom: 1px solid var(--border); } #content { padding: 24px; } }
      </style>
    </head>
    <body>
